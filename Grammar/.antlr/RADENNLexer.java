...
public class RADENNLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INT", "FLOAT", "STR", "IDENTIFIER", "NOT", "EQ", "PLUS", "MINUS", "MUL", 
			"DIV", "MOD", "POW", "EE", "NE", "LT", "GT", "LTE", "GTE", "AND", "OR", 
			"COMMA", "SEMICOLON", "LPAREN", "RPAREN", "LSQUARE", "RSQUARE", "LROUND", 
			"RROUND", "NEWLINE", "WS", "COMMENT"
		};
	}
